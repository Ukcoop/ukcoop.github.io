...
export default function Hero() {
  return (
    <div className="w-full h-svh overflow-x-clip overflow-y-auto relative">
      <Sketch />
      <div className="flex flex-col sm:pt-20 pt-5 sm:px-10 px-2 absolute top-0 left-0 z-10 w-full h-full dark:bg-black/40 bg-white/20">
        <div className="flex flex-col p-5 w-max max-w-full rounded-lg dark:bg-black/50 bg-white/70">
